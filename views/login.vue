    ...
    <div class="site-content__wrapper">
      <div class="site-content">
        <div class="brand-info">
          <h2 class="brand-info__text">教学质量测评系统后台</h2>
          <p class="brand-info__intro">该系统是基于vue、element-ui构建开发实现,利用Paillier算法,提供一套更优的,更安全的解决方案。</p>
        </div>
        <div class="login-main">
          <h3 class="login-title" style="font-weight:bold">管理员登录</h3>
          <br>
          <el-form status-icon>
            <el-form-item>
              <el-input v-model="loginuser.id" placeholder="帐号"></el-input>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      axios.post("http://" + ip +port_back+ "/admin", this.loginuser).then(res => {

        if (res.data.code == 20001) {

          location.href = "http://"+ip+":8888/#/home"
